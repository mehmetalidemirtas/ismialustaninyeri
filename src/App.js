...
const Gallery = () => {
    ...
    const photoPaths = Array.from({ length: 28 },
        (_, i) => `/assets/${i + 1}.jpg`
    );
    useEffect(() => {
        const interval = setInterval(() => {
    ...
    return ( <
        ...
        div ref = { mapRef } >
        <
        iframe src = "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d199.64229725954024!2d34.61115175879984!3d36.81188754477042!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1527f39b9fbebaeb%3A0x302ab86eded6f053!2sOsmaniye%2C%2081043.%20Sk.%20No%3A4%2C%2033220%20Toroslar%2FMersin!5e0!3m2!1str!2str!4v1708281745368!5m2!1str!2str"
        width = "100%"
        height = "450"
        allowFullScreen = ""
        loading = "lazy"
